...
const TruthSection = lazy(() => import('./components/sections/TruthSection').then(m => ({ default: m.TruthSection })))
const HybridOffer = lazy(() => import('./components/sections/HybridOffer').then(m => ({ default: m.HybridOffer })))
