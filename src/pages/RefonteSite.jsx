    ...
    <div className={`min-h-screen ${theme === 'light' ? 'bg-white' : 'bg-background'}`}>
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        >
          ...
          >
            Transformez votre site existant avec un design ultra-premium qui convertit
          </motion.p>
          ...
          >
            {[
              { label: 'Sites transformés', value: '70+' },
              { label: 'ROI moyen', value: '+480%' },
              { label: 'Livraison', value: '7-21 jours' },
              ...
              return (
                ...
                >
                  ...
                  <div className="text-center mb-8">
                    ...
                    {tier.oldPrice && (
                      <div className={`text-sm line-through ${theme === 'light' ? 'text-gray-500' : 'text-gray-500'}`}>
                        {tier.oldPrice.toLocaleString('fr-FR')}€
                      </div>
                    )}
                  </div>
      ...
      <section className="py-20 px-6 bg-black/5">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            Complétez votre refonte avec nos services premium
          </motion.p>

          <div className="grid md:grid-cols-3 gap-6">
            {refonteServices.map((service, index) => (
              <motion.div
                key={service.id}
