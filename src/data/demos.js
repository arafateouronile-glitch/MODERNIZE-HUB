export const demos = [
  ...
  },
  {
    ...
    story: '"On perdait face aux salles low-cost. Notre site ne transmettait pas l\'énergie de nos coachs. Le nouveau design avec couleurs vibrantes et animations 3D reflète enfin notre ADN. Inscriptions explosées, rétention membres au top. Game changer total." - Alex, Fondateur',
    before: {
    ...
    after: {
      ...
      benefits: ['Couleurs vibrantes', 'Animations énergétiques', '+180% inscriptions'],
    },
    stats: [
    ...
    description: 'Site énergique avec couleurs vibrantes, animations dynamiques et système de réservation.',
